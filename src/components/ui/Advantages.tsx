          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              <h2 className="text-3xl font-bold sm:text-4xl">
                The Internet Computer Protocal
              </h2>

              <p className="mt-4 text-gray-600">
                The Inua DAO is built on the Internet Computer Protocal. Inua
                DAO has been designed to tap into the new features offered by
                ICP. These features ensure safety, anonimity and security of the
                DAO and its members.
              </p>

              <a
                href="#"
                className="mt-8 inline-block rounded bg-green-500 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-green-500 border-[1px] border-green-500"
              >
                See Documentation
              </a>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              ...
              >
                ...
                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                  ...
                  built on ICP or other blockchains.
                </p>
              </a>
              ...
              >
                ...
                <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                  ...
                  intermediaries or cloud providers
                </p>
              </a>
